...
题目链接：[LeetCode](https://leetcode.com/problems/time-based-key-value-store/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/time-based-key-value-store/description/)
